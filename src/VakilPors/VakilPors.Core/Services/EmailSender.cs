...
namespace VakilPors.Core.Services
{
    public class EmailSender : IEmailSender// , IDisposable
    {
        ...
        public EmailSender(IConfiguration configuration, ILogger<EmailSender> logger ,MimeMessage mimeMessage = null,SmtpClient client = null)
        {
        ...
        public async Task SendEmailAsync(string email, string name, string subject, string htmlMessage, bool useHtml = true)
        {
            ...
            try
            {
                ...
                _message.From.Add(new MailboxAddress(_fromName, _fromEmail));
