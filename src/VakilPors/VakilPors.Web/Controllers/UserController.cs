...
public class UserController:MyControllerBase
{
    ...
    {
        _logger.LogInformation($"GET ALL users paged. page no:{pagedParams.PageNumber} page size:{pagedParams.PageSize}, search query:{query}, sort by:{sortParams.Sort}, isAscending:{sortParams.IsAscending}");
