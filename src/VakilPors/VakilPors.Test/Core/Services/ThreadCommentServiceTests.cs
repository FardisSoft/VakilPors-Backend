...
namespace VakilPors.Test.Core.Services
{
    public class ThreadCommentServiceTests
    {
        ...
        [Fact]
        public async Task undosetasanswer()
        {
            //Arrange
            var userid = 1;
            var commentid = 1;
            ...
            //Act 
            var result = await threadCommentService.UndoSetAsAnswer(userid, commentid);
        ...
        [Fact]
        public async Task threadanswercount()
        {
            //Arrange
            var userid = 1;
            var commentid = 1;
            ...
            IEnumerable<ThreadComment> threadComments = new List<ThreadComment>()
            {
                new ThreadComment {UserLikes = new List<UserCommentLike>(){ new UserCommentLike() { UserId = 1 , CommentId = 1} } , Id = 1 , Thread = new ForumThread(){UserId = 1 }  , UserId = 10, ThreadId = 1}
            ...
            lawyerservicesmock.Setup(u => u.AddToken(It.IsAny<int>(), It.IsAny<int>()));
            //Act 
            var result = await threadCommentService.GetThreadAnswerCount(thredid);
        ...
        //[Fact]
        //public async Task iscommentliked()
        //{
        //    //Arrange
        //    var userid = 1;
        //    var commentid = 1;
        ...
        //    lawyerservicesmock.Setup(u => u.AddToken(It.IsAny<int>(), It.IsAny<int>()));
        //    //Act 
        //    var result = await threadCommentService.IsCommentLikedByUser(userid, thredid);
